...
親: spec_zero_attraction_learning_0913.md（vault では [[零点復元と重み収縮_学習実験_spec_0913]]）/ 格: 本走中に起案した追加解析。追加解析の実装・実行前に固定。/ 状態: **実行済み**（7 条件 × 2 境界の自然更新再生 → [[零点復元と重み収縮_新規学習結果_0913]]。2026-09-17 に `spec/実行済み/` へ移動）
