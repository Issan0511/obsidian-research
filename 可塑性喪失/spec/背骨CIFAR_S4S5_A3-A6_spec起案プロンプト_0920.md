...
親: [[中心主張v11作業リスト_0920]] §2 / 前身: [[初版必須走S1-S3_spec起案プロンプト_0919]]（共通の前置きはそちらの §「共通の前置き」をそのまま先頭に付ける） / 状態: **起案プロンプト。A6 は spec 化・実施済み（0920・末尾の追補に訂正）。S4・S5・A3–A5 の spec はまだ無い。Issa「背骨を CIFAR にします」（0920）を受けて作成** / 作成: 2026-09-20 / 起草: Claude
